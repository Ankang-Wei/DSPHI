...
A: ndarray = zeros((153, 64), dtype=float)  # 先创建一个全零方阵A，并且数据的类型设置为float浮点型
f = open('data/only-host_kmers.csv', "r")
...
with open("data/only-host-cos3.csv", 'w', newline='', encoding='utf-8') as f:
